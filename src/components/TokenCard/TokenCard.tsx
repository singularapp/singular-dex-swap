...
export default function TokenCard({ showRedirectModal }: Props) {
  ...
  const glvsIncentivizedLabel = useMemo(() => {
    ...
    if (hasArbitrumGlvIncentives && hasAvaxGlvIncentives) {
      return (
        <Trans>
          {arbitrumLink} and {avalancheLink} SLV Pools are{" "}
      ...
      return (
        <Trans>
          {arbitrumLink} SLV Pools are <span className="whitespace-nowrap">incentivized{sparkle}.</span>
        </Trans>
      );
    } else if (hasAvaxGlvIncentives) {
      return (
        <Trans>
          {avalancheLink} SLV Pools are <span className="whitespace-nowrap">incentivized{sparkle}.</span>
        </Trans>
      );
    } else {
      return null;
  ...
  return (
    <div className="Home-token-card-options">
        ...
        <div>
          ...
          <div className="Home-token-card-option-info">
            ...
            <div className="Home-token-card-option-apr">
              <Trans>Arbitrum APR:</Trans> <APRLabel chainId={ARBITRUM} label="avgSDAprTotal" />,{" "}
              <Trans>Avalanche APR:</Trans> <APRLabel chainId={AVALANCHE} label="avgSDAprTotal" />
            </div>
          </div>
        </div>
      ...
      <div className="Home-token-card-option">
        <div>
          <div className="Home-token-card-option-icon">
            <img src={glvIcon} alt="SLV icon" /> SLV
          </div>
          <div className="Home-token-card-option-info">
            <div className="Home-token-card-option-title">
              <Trans>
                SLV is the liquidity provider token for SD V2 vaults. Consist of several SD tokens and accrues fees
                generated by them.
              </Trans>
            </div>
          </div>
      ...
      <div className="Home-token-card-option">
        <div>
          ...
          <div className="Home-token-card-option-info">
            <div className="Home-token-card-option-title">
              <Trans>
                SD is the liquidity provider token for SD V2 markets. Accrues 63% of the V2 markets generated fees.
              </Trans>
            </div>
          </div>
