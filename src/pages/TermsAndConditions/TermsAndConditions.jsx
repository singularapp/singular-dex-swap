      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">SINGULARDAO</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to dapp.singulardex.com ("we," "us," or "our"), the informational resource for SINGULARDAO Protocol, as defined below.
              </p>
              <p className="body-text">
                dapp.singulardex.com provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the SINGULARDAO Protocol (the "SINGULARDAO Protocol," "Protocol," or "SINGULARDAO DApp"). dapp.singulardex.com is not an
                available access point to the SINGULARDAO Protocol.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                dapp.singulardex.com is not part of any transaction on the blockchain networks underlying the SINGULARDAO Protocol; we do not
                ...
                any crypto assets. You understand that when you interact with any SINGULARDAO Protocol smart contracts, you
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    that you may access or use on or through the Site or the Interface; however, the code for the SINGULARDAO
            ...
            <div className="section">
              ...
              <p className="body-text">
                dapp.singulardex.com is an informational site for the SINGULARDAO Protocol. dapp.singulardex.com does not operate an exchange platform or
