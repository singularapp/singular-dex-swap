...
import { STATIC_LINKS } from "config/links";
      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">SINGULAR</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to dapp.singulardex.com ("we," "us," or "our"), the informational resource for SINGULAR
                Protocol, as defined below.
              </p>
              <p className="body-text">
                dapp.singulardex.com provides information and resources about the fundamentals of the decentralized
                non-custodial protocol called the SINGULAR Protocol (the "SINGULAR Protocol," "Protocol," or "SINGULAR
                DApp"). dapp.singulardex.com is not an available access point to the SINGULAR Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access dapp.singulardex.com ("the Site") and dapp.singulardex.com ("the
            ...
            <div className="section">
              ...
              <p className="body-text">The dapp.singulardex.com site is for informational purposes only.</p>
              <p className="body-text">
                dapp.singulardex.com is not part of any transaction on the blockchain networks underlying the SINGULAR
                ...
                store, send, or receive any crypto assets. You understand that when you interact with any SINGULAR
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    dapp.singulardex.com the following:
                  </p>
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over dapp.singulardex.com or you as otherwise duly
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that dapp.singulardex.com or any of its suppliers or contractors may
                        undertake from time to time; (c) causes beyond dapp.singulardex.com's control or that
                        dapp.singulardex.com could not reasonably foresee; (d) disruptions and temporary or permanent
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with dapp.singulardex.com;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                        1.2.5. dapp.singulardex.com does not act as a broker or advisor for you;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. dapp.singulardex.com does not receive fees for any blockchain transactions or using the Site or
                the Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. dapp.singulardex.com own all rights, names, logos, and other marks used on the Site and the
                    ...
                    the SINGULAR Protocol and the Interface (dapp.singulardex.com) deployed on IPFS is open-sourced.
                ...
                <li>
                  <p className="body-text">
                    4.2. dapp.singulardex.com may use and share your comments, bug reports, ideas, or other feedback
                    that you may provide, including suggestions about how we might improve. You agree that
                    dapp.singulardex.com is free to use or not use any feedback we receive from you as we see fit,
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. dapp.singulardex.com reserve the right, at our sole discretion, from time to time and with or
                    ...
                    do not host or own its code. dapp.singulardex.com will not be liable for any losses suffered by you
                ...
                <li>
                  <p className="body-text">
                    {`5.2. dapp.singulardex.com may revise these Terms from time to time. We will notify you by updating the date at the
                    top of the Terms and maintaining a current version. The most current version of the Terms will
                    always be at ${STATIC_LINKS.PrivacyPolicy}. All modifications will be effective when they
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. dapp.singulardex.com does
                    not own or control any underlying software through which blockchain networks are formed. The
                    software underlying blockchain networks are open-source so anyone can use, copy, modify, and
                    distribute it. By using the Interface, you acknowledge and agree:
                  </p>
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That dapp.singulardex.com is not responsible for the operation of the open-source
                        software and networks underlying the Interface;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither dapp.singulardex.com nor any other person or entity will be
                        able to retrieve or protect your digital assets. If your private key(s) are lost, you will not
                        be able to transfer your digital assets to any blockchain address or wallet. If this occurs, you
                        will not be able to realize any value or utility from the digital assets you may hold.
                      </p>
                    </li>
                  </ul>
                </li>
                <li>
                  <p className="body-text">
                    6.2. dapp.singulardex.com is not responsible for the content of any third party, including, but not
                    limited to, information, materials, products, or services that dapp.singulardex.com does not own or
                    control. In addition, third parties may offer promotions related to your access and use of the
                    Interface. dapp.singulardex.com does not endorse or assume any responsibility for such resources or
                    ...
                    relationships with any third parties. You expressly relieve dapp.singulardex.com of all liability
                    arising from using such resources or participating in such promotions.
                  </p>
                </li>
                <li>
                  <p className="body-text">
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that dapp.singulardex.com will have no responsibility or liability
                    for the risks in Section 9. You hereby irrevocably waive, release and discharge all claims, whether
                    known or unknown to you, against dapp.singulardex.com, its affiliates, and their respective
                    shareholders, members, directors, officers, employees, agents, representatives, suppliers, and
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of dapp.singulardex.com;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including dapp.singulardex.com's
            ...
            <div className="section">
              ...
              <p className="body-text">
                dapp.singulardex.com is an informational site for the SINGULAR Protocol. dapp.singulardex.com does not
                operate an exchange platform or offer trade execution or clearing services and has no oversight,
                involvement, or control concerning your transactions using the Interface. All transactions between users
                of the Interface are executed peer-to-peer directly between the users' blockchain addresses through a
              ...
              <p className="body-text">
                You understand that dapp.singulardex.com is not registered or licensed by any regulatory agency or
                authority. No such agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis.
                dapp.singulardex.com makes no guarantees of any kind or connection with the Site or the Interface.
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">9. LIMITATION OF LIABILITY</h3>
              <p className="body-text">
                In no event shall dapp.singulardex.com, its affiliates, its suppliers and contractors, and its
                affiliates', suppliers' and contractors' respective stockholders, members, directors, officers,
                managers, employees, attorneys, agents, representatives, suppliers, and contractors shall be liable for
                any direct, indirect, incidental, special, punitive, consequential or similar damages or liabilities
                ...
                connection with the Site or the Interface, or other item provided by or on behalf of
                dapp.singulardex.com, whether under contract, tort (including negligence), civil liability, statute,
                strict liability, breach of warranties, or under any other theory of liability, and whether or not we
                have been advised of, knew of or should have known of the possibility of such damages and
                notwithstanding any failure of the essential purpose of these Terms or any limited remedy hereunder nor
                is dapp.singulardex.com in any way responsible for the execution or settlement of transactions between
                users of the Interface.
              </p>
              <p className="body-text">
                In no event shall dapp.singulardex.com's aggregate liability arising out of or in connection with the
                Site or Interface exceed one thousand Singapore Dollars (1,000.00 SGD).
              </p>
            </div>
            <div className="section">
              <h3 className="body-title">10. INDEMNIFICATION</h3>
              <p className="body-text">
                You will defend, indemnify, and hold harmless dapp.singulardex.com, its affiliates, members, member,
            ...
            <div className="section">
              ...
              <p className="body-text">
                dapp.singulardex.com will use its best efforts to resolve potential disputes through informal, good
                faith negotiations. If a potential dispute arises, you must contact us by sending a written notice of
                your claim ("Notice") to dapp.singulardex.com on any of our official channels. The notice must (a)
                describe the nature and basis of the claim and (b) set forth the specific relief sought. Our notice to
                you will be similar in form to that described above. If you and dapp.singulardex.com cannot reach an
                agreement to resolve the claim within sixty (60) days of your email, then you and dapp.singulardex.com
              ...
              <p className="body-text">
                ...
                dapp.singulardex.com will not have the right to assert the claim.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of dapp.singulardex.com set forth in these Terms is in addition to, and
                    not in lieu of, any other right or remedy whether described in these Terms, under Applicable Law, at
                    law, or in equity. The failure or delay of dapp.singulardex.com in exercising any right, power, or
                ...
                <li>
                  <p className="body-text">
                    13.4. dapp.singulardex.com will have no responsibility or liability for any failure or delay in
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and dapp.singulardex.com and supersede
                    all prior and contemporaneous understandings between the parties regarding the Interface and the
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                dapp.singulardex.com on any of our official channels.
              </p>
            </div>
          </div>
        </div>
